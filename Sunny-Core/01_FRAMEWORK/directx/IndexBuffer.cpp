...
namespace sunny
{
	namespace directx
	{
		...
		void IndexBuffer::Bind() const
		{
			...
			Context::GetDeviceContext(m_dimension)->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
			...
			Context::GetDeviceContext(m_dimension)->IASetIndexBuffer(m_bufferHandle, DXGI_FORMAT_R32_UINT, 0);
		}
