	...
	namespace graphics
	{
		namespace MeshFactory
		{
			...
			Mesh* CreatePlane(float width, float height, const maths::vec3& normal)
			{
				...
				maths::mat4 rotation = maths::mat4::Rotate(vec.z, maths::vec3(1, 0, 0)) * maths::mat4::Rotate(vec.y, maths::vec3(0, 1, 0)) * maths::mat4::Rotate(vec.x, maths::vec3(0, 0, 1));
