...
#if _WIN32 || _WIN64
#if _WIN64
#pragma comment(lib, "dependency/freetype/win64/freetype.lib")
#else
#pragma comment(lib, "dependency/freetype/win32/freetype.lib")
#endif
#endif
...
namespace sunny
{
	namespace graphics
	{
		...
		: m_name(name), m_fileName(fileName), m_size(size), m_scale(maths::vec2(1.0f, 1.0f)), m_texture(nullptr)
		{
			...
			m_texture = directx::Texture2D::Create(512, 512);
